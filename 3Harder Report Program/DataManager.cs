...
namespace _3Harder_Report_Program
{
    ...
    class DataManager
    {
        ...
        public void AddAccount(Account account)
        {
            ...
            SQLiteCommand addAccountCmd = new SQLiteCommand("INSERT INTO accounts (username, password, admin) VALUES (?, ?, ?);", connection);
            addAccountCmd.Parameters.Add(account.username);
            addAccountCmd.Parameters.Add(account.password);
            addAccountCmd.Parameters.Add(account.admin);
        ...
        public void RemoveAccount(string username)
        {
            ...
            SQLiteCommand removeAccountCmd = new SQLiteCommand("DELETE FROM accounts WHERE username=?;", connection);
            removeAccountCmd.Parameters.Add(username);
